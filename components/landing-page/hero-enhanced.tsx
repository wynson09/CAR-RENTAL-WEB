          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center justify-center relative z-10">
            ...
            >
              ...
              >
                ...
                <div className="flex">
                  {[...Array(5)].map((_, i) => (
                    <Icon key={i} icon="heroicons:star" className="w-3 h-3 text-yellow-400 fill-current" />
                  ))}
                </div>
              </motion.div>
              ...
              >
                <Button asChild size="xl" className="bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 shadow-lg hover:shadow-xl transition-all duration-300">
                  <Link href="/dashboard" className="flex items-center">
                    <Icon icon="heroicons:rocket-launch" className="w-5 h-5 mr-2" />
                    Get Started Today
                  </Link>
                </Button>
                <Button asChild variant="outline" size="xl" className="border-primary/30 text-primary hover:bg-primary/5 shadow-md">
            ...
            >
              ...
              <div className="absolute lg:top-1/4 top-[20%] right-0 lg:w-[100%] w-[100%] lg:h-[60%] h-[80%] transform -rotate-6 scale-x-[-1]">
                <svg fill="none" viewBox="0 0 342 175" className="w-full h-full absolute inset-0" xmlns="http://www.w3.org/2000/svg">
                  ...
                  />
                  <defs>
                    <linearGradient gradientUnits="userSpaceOnUse" y2="128" x2="354.142" y1="128" x1="0" id="paint0_linear_hero_bg">

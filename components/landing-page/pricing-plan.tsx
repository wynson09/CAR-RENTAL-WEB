      ...
      <div className="container">
        <div className="max-w-[670px] mx-auto ">
          ...
          <p className="text-base xl:leading-7 text-center text-default-700 ">
            DashTail stands as a prudent investment, safeguarding you against thousands in potential
            expenses. With every update, amplify its value even further.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-y-8 lg:gap-x-12">
            ...
            <div className="bg-default-100 rounded-xl py-10 px-7 flex flex-col">
              <div className="flex-none">
                ...
                <p className="text-sm xl:text-base  text-default-600">
                  Suitable for you or one client, this license covers a single end product that is
                  accessible to end users{' '}
                  <span className="font-medium text-primary">without charge.</span>
                </p>
              </div>
              <div className="flex-1">
                ...
                <ul className="space-y-3">
                  <li className="flex items-center gap-3">
                    <Icon icon="heroicons:check-16-solid" className="w-4 h-4 text-success" />
                  ...
                  <li className="flex items-center gap-3">
                    <Icon icon="heroicons:x-mark-16-solid" className="w-4 h-4 text-destructive" />
                    <span className="text-sm xl:text-base text-default-900">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-center gap-3">
                  <Icon icon="heroicons:x-mark-16-solid" className="w-4 h-4 text-destructive" />
                  <span className="text-sm xl:text-base  text-default-900">Free installation.</span>
                </li>
              </ul>
              <Button asChild>
                <Link
            ...
            <div className="bg-default-100 rounded-xl py-8 px-6 flex flex-col">
              <div className="flex-none">
                ...
                <p className="text-sm xl:text-base  text-default-600">
                  Should your business necessitate a unique licensing arrangement, please
                  <Link

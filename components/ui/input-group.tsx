...
const InputGroupButton = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
  ...
  ({ className, color, ...props }, ref) => (
    <div
      ...
      className={cn(
        ...
        className,
        {
          'border-info/50 group-focus-within:border-info-700 ring-info-700': color === 'info',

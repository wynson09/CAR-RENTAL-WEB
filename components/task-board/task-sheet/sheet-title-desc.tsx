...
const SheetTitleDesc = ({ task, taskId }: { task: TaskType; taskId: TaskType['id'] }) => {
  ...
  return (
    <form className="py-5 px-6 pb-8 border-b border-default-200" onSubmit={handleSubmit(onSubmit)}>
      ...
      {errors.title && <div className=" text-destructive">{errors.title.message as string}</div>}

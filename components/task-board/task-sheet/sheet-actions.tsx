...
const SheetActions = ({ task, taskId }: { task: TaskType; taskId: TaskType['id'] }) => {
  return (
      ...
      <div className="grid  grid-cols-2  md:grid-cols-3 md:gap-2 gap-y-6">
        ...
        <div>
          ...
          <div className="flex items-center gap-3">
            {task?.assign?.length > 0 && (
              <AvatarGroup countClass="w-5 h-5" total={task?.assign?.length} max={3}>
        ...
        <div>
          <div className="flex items-center gap-1 mb-1">
            ...
            <span className="text-sm font-medium text-default-900">Dependency</span>
          </div>
          <Dependency />
        </div>
        <div>
          <div className="flex items-center gap-1 mb-3">
            ...
            <span className="text-sm font-medium text-default-900">Story Points</span>
          </div>
          <StoryPoint />
        </div>
      </div>

...
const AddTask = ({ onClose, boardId }: { onClose: () => void; boardId: BoardType['id'] }) => {
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <CardHeader className="mb-0">
          <div>
            ...
            {/* active list */}
            <div className="text-xs font-medium text-default-600">UX/UI Design</div>
          </div>
        </CardHeader>
        ...
        <CardFooter className="mt-1 justify-end gap-3 pt-0 p-3">
          <Button type="button" color="destructive" variant="soft" onClick={onClose}>
            Cancel
          </Button>

...
export const projects = [
  ...
  },
  {
    ...
    subtitle: 'UR-Advisor stands as a lightweight quiz/survey web application built on PHP.',
    status: 'in progress',
    label: 'bug',
    priority: 'low',
    description: 'UR-Advisor stands as a lightweight quiz/survey web application built on PHP.',
    percentage: 61,
    assign: [

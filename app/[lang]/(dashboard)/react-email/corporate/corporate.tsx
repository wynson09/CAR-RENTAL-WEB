            ...
            <Section>
              <Row>
                ...
                <Column className="flex justify-end items-center gap-4 py-4 pr-8">
                  <Link href="/" className="text-sm font-medium text-gray-500 mt-1.5">
                    Home
                  </Link>
                  <Link href="/" className="text-sm font-medium text-gray-500 mt-1.5">
                    Services
              ...
              <Row>
                <Column className="flex flex-col items-center relative before:absolute before:top-0 before:left-0 before:w-full before:h-full before:bg-gray-900/60 before:z-10 py-10 pb-16">
                  ...
                  <Text className="relative z-30 text-center text-base text-white  px-10 my-0">
                    Codeshaper is a creative agency that helps people to bring their business
                    online. we also offer various digital marketing, web design, and development
                    services.
                  </Text>
                  <Button
              ...
              <Row>
                <Column className="pt-10 pb-5">
                  ...
                  <Text className="px-10 text-base text-gray-500 text-center">
                    The works that don't compromise with quality and standard. We're creating
                    awesome projects
                  </Text>
                </Column>
              </Row>
                  ...
                  <Row>
                    ...
                    <Column className="w-1/2">
                      ...
                      <Text className="text-sm texty-gray-500">
                        Codeshaper is a creative agency that helps people to bring their business
                        online. we also offer web development services.
                      </Text>
                      <Button
                ...
                <Column className="bg-gray-900 text-white pt-12 px-10">
                  <Row>
                    ...
                    <Column className="pl-2 w-1/3">
                      ...
                      <Link href="/" className="text-sm font-medium text-slate-400 mt-1.5 block">
                        Home
                      </Link>
                      <Link href="/" className="text-sm font-medium text-slate-400 mt-1.5 block">
                        Services
                  ...
                  <Row>
                    <Column className="pt-10 pb-2">
                      <Text className="text-xs text-slate-300">
                        COPYRIGHT &copy; 2024 DashTail All rights <br /> Reserved
                      </Text>
                    </Column>
                    <Column className="pt-10 pb-2">
                      <Link href="/" className="text-xs font-medium  text-slate-300">
                        Unsubscribe
                      </Link>
                    </Column>
                  </Row>

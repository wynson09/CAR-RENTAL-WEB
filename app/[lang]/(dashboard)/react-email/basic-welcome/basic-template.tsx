              ...
              <Row>
                <Column className="p-10 pb-5">
                  ...
                  <Text className="text-base text-default-700 text-center">
                    Welcome to CodeShaper, where innovation meets precision. Crafting your digital
                    future with elegant solutions. Let's shape your success together. Evolve, adapt,
                    conquer.
                  </Text>
                  ...
                  <Text className="text-xs leading-6 text-center text-default-700">
                    3rd Floor, Road# 29, House# 395, New DOHS, <br /> Mohakhali, Dhaka - 1206,
                    Bangladesh
                  </Text>
                </Column>
              </Row>

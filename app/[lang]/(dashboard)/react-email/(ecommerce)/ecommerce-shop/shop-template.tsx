        ...
        <Body style={main}>
          <Container style={container}>
            ...
            <Section className="flex justify-center">
              <Link href="/" className="text-sm font-medium text-gray-900 px-4 py-2.5 inline-block">
                Home
              </Link>
              <Link
                href="/"
                className="text-sm font-medium text-gray-900 px-4  py-2.5 inline-block"
              >
                New
              </Link>
              <Link
            ...
            <Text className="px-10 py-10 text-xl leading-8  text-gray-800 text-center">
              Find Amazing Deals on Our Shopping Website! Great{' '}
              <span className="text-violet-600">Prices</span> and
              <span className="text-violet-600"> Big Discounts </span> Await You!
            </Text>
            <Section>
              <Row className="bg-gray-50">
                <Column className="w-1/2">
                  <Text className="px-5 text-lg font-medium text-gray-900">
                    Youthful Woman Dresses
                  </Text>
                  <Text className="px-5 text-sm  text-gray-700">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit Inventore aliquam.{' '}
                  </Text>
                  <Button
                    className="border border-violet-500 bg-violet-500 text-white font-medium py-2 px-5 rounded ml-5 mt-4"
                    href="/"
                  >
                    SHOP NOW
                  </Button>
            ...
            <Section>
              <Row>
                <Column>
                  <Text className="text-sm  text-gray-900 pl-10">
                    Keep up with shopping updates
                  </Text>
                </Column>

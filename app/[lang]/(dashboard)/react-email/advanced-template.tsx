        ...
        <Container className="mx-auto bg-white rounded">
          ...
          <Section className=" mt-5">
            <Row>
              <Column className="flex flex-col items-center p-5 mx-5 bg-slate-200   border border-slate-300 rounded-md">
                <Img src={avatar.src} alt="Logo" className="w-12 h-12 rounded-full" />
          ...
          <Section className="mt-5">
            ...
            <Text className="text-sm  text-slate-700 px-5">
              The package comes with a one-month complimentary plan, enabling users to experience
              the service at no cost for the first month. Take advantage of this introductory offer
              now!
            </Text>
          </Section>
          <Section>
            <Row>
              <Column className="min-w-[78px]">
                <Img src={clock.src} alt="Logo" className="w-12 h-12 block m-auto" />
              </Column>
              <Column>
                <Text className="text-lg font-medium text-slate-900">24/7 Client Support</Text>
                <Text className="text-sm  text-slate-700 -mt-2">
                  We offer 24/7 client support for your convenience, ensuring assistance is
                  available whenever you need it, day or night.
                </Text>
              </Column>
            </Row>
          ...
          <Section className="mt-5">
            ...
            <Row className="mt-5 ">
              <Column className="pr-2 w-1/2 pl-5">
                <Img src={blog1.src} alt="Logo" className="w-full h-full object-cover rounded-md" />
              ...
              <Column className="pl-2 w-1/2 pr-5">
                ...
                />
                <Text className="text-sm font-medium text-slate-900">How to use starter kit?</Text>
                <Text className="text-sm text-slate-700 -mt-2">
                  Edit template: adjust text, images, colors as desired.
                </Text>
              </Column>
          ...
          <Section className="bg-slate-300  mt-5">
            <Row>
              <Column className="w-1/2 pl-5">
                <Img src={logo2.src} alt="Logo" className="w-12 h-12 object-cover  " />
          ...
          <Section className="mt-5 text-center">
            <Text className="text-sm text-slate-700">
              3rd Floor, Road# 29, House# 395, New DOHS, <br /> Mohakhali, Dhaka - 1206, Bangladesh
            </Text>

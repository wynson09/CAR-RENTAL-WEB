    ...
    <div className="  space-y-5">
      <Card title="Color Alert" code={colorAlert}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The <code className="text-primary">color</code> props of alert change the color.
        </p>
        <ColorAlert />
      </Card>
      <Card title="Outline Alert" code={outlineAlert}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The <code className="text-primary">variant="outline"</code> props of alert change the
          outline of alert.
        </p>
        <OutlineAlert />
      </Card>
      <Card title="Soft Alert" code={softAlert}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The <code className="text-primary"> variant="soft"</code> props of alert change to soft
          background of alert .
        </p>
      ...
      <Card title="Alert With Link" code={linkAlert}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The alert<code className="text-primary">link</code> will direct user to new page .
        </p>
        <LinkAlert />
      </Card>
      <Card title="Dismissible Color Alerts" code={disableAlert}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The alert <code className="text-primary">dismissible</code> props remove the alert .
        </p>
        <DisableAlert />
      </Card>
      <Card title="Dismissible Outline Alerts" code={dismissibleOutlineAlert}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The alert <code className="text-primary">dismissible and variant="outline"</code> props
          remove the alert .
        </p>
        <DismissibleOutlineAlert />
      </Card>
      <Card title="Dismissible Soft Alerts" code={dismissibleSoftColor}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The alert <code className="text-primary">dismissible and variant="soft"</code> props
          remove the alert .
        </p>
        <DismissibleSoftColor />
      </Card>
      <Card title="Dismissible Soft Alerts With Icon" code={disableSoftIcon}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The alert <code className="text-primary">dismissible and Icon</code> props component to
          add design and remove the alert .
        </p>
        <DisableSoftIcon />
      </Card>
      <Card title="Bordered Alert" code={borderAlert}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The alert <code className="text-primary">dismissible and Border</code> props component to
          add design and remove the alert .
        </p>
        <BorderAlert />
      </Card>
      <Card title="Alerts With Heading" code={headingAlert}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The alert <code className="text-primary">dismissible and Large heading</code> props
          component to add design and remove the alert .
        </p>
        <HeadingAlert />
      </Card>
      <Card title="Alert Headings With Icon" code={headingAlertIcon}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The alert <code className="text-primary">dismissible and Large heading With Icon</code>{' '}

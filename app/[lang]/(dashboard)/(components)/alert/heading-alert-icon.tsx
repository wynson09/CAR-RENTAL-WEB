  ...
  return (
    <div className="space-y-4">
      <Alert variant="soft" dismissible>
        <Icon icon="heroicons:tv" className="h-6 w-6 self-start relative top-1  " />
      ...
      <Alert color="secondary" variant="soft">
        <Icon icon="heroicons:signal" className="h-6 w-6 self-start relative top-1  " />
        <div className=" flex-1">
      ...
      <Alert color="success" variant="soft">
        <Icon icon="heroicons:check" className="h-6 w-6 self-start relative top-1  " />
        <div className=" flex-1">
      ...
      <Alert color="destructive" variant="soft">
        <Icon icon="heroicons:trash" className="h-6 w-6 self-start relative top-1  " />
        <div className=" flex-1">
      ...
      <Alert color="info" variant="soft">
        <Icon icon="heroicons:information-circle" className="h-6 w-6 self-start relative top-1  " />
        <div className=" flex-1">
      ...
      <Alert color="dark" variant="soft">
        <Icon icon="heroicons:at-symbol" className="h-6 w-6 self-start relative top-1  " />
        <div className=" flex-1">

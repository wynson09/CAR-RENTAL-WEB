      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent className="w-[196px] " align="start">
          ...
          <DropdownMenuItem className=" focus:bg-default-200 focus:text-default-950 text-default-500 cursor-pointer">
            <Icon icon="heroicons:chart-pie" className="w-4 h-4 ltr:mr-2 rtl:ml-2 mt-1 " />
            <p className="text-sm leading-5 ">Text Item</p>
          </DropdownMenuItem>
          <DropdownMenuItem className=" focus:bg-default-200 focus:text-default-950 text-default-500 cursor-pointer">
            <Icon icon="heroicons:user" className="w-4 h-4 ltr:mr-2 rtl:ml-2 mt-1 " />
            <p className="text-sm leading-5 ">Number Item</p>
          </DropdownMenuItem>
          <DropdownMenuItem className=" focus:bg-default-200 focus:text-default-950 text-default-500 cursor-pointer">
            <Icon icon="heroicons:calendar" className="w-4 h-4 ltr:mr-2 rtl:ml-2 mt-1 " />
            <p className="text-sm leading-5 ">Date Item</p>
          </DropdownMenuItem>
          <DropdownMenuItem className=" focus:bg-default-200 focus:text-default-950 text-default-500 cursor-pointer">
            <Icon icon="heroicons:clipboard-document" className="w-4 h-4 ltr:mr-2 rtl:ml-2 mt-1 " />

      ...
      <Timeline>
        <TimelineItem>
          ...
          <TimelineContent>
            ...
            <p className="text-sm text-default-500  mt-1">Jone Doer changed his avatar photo</p>
          </TimelineContent>
        </TimelineItem>
        <TimelineItem>
          <TimelineSeparator>
          ...
          <TimelineContent>
            ...
            <p className="text-sm text-default-500  mt-1">Mores Clarke added new video</p>
          </TimelineContent>
        </TimelineItem>
        <TimelineItem>
          <TimelineSeparator>
        ...
        <TimelineItem>
          ...
          <TimelineContent>
            <div className="md:flex gap-4">
              <div className="grow">
                <h5 className="font-medium text-sm text-default-600 ">Weekly Report</h5>
              </div>
              <div className="text-default-400 text-xs md:min-w-[90px] md:max-w-[120px] md:text-right">
                a day ago
              </div>
            </div>
            <p className="text-sm text-default-500  mt-1">The weekly report was uploaded</p>
          </TimelineContent>
        </TimelineItem>
      </Timeline>
    </div>

          ...
          >
            <SwiperSlide>
              <div className="h-[300px] md:h-[410px] rounded-md">
                <Image src={slider1} className="w-full h-full object-cover  rounded-md" alt="" />
              </div>
              <div className="my-5 pb-5">
                <p className="text-sm text-default-500  text-center">
                  If we’re talking about the world’s most beautiful mountains, you’ve got to begin
                  with Mount Fuji. Aesthetically speaking, it’s one of the most iconic mountains on
                  the planet.
                </p>
              </div>
            </SwiperSlide>

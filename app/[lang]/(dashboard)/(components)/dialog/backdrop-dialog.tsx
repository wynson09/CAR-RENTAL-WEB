          ...
          <Tabs defaultValue="link" className="w-full">
            ...
            <TabsContent value="code">
              <h2 className="my-6 text-sm font-medium text-default-700 ">
                Start using your modals components by coping the web address below
              </h2>
              <div className="flex flex-row gap-2 mb-2">
                <Input type="text" placeholder="https://share.modals.comps.com/component5xwo6a" />
                <Button type="button">Copy</Button>
              </div>
              <Link href="preview" className="text-xs font-medium text-default-700  underline">
                Preview link in new tab
              </Link>
              <div className="flex items-center gap-2 mt-5">
                <Checkbox id="cb_1" />
                <Label htmlFor="cb_1" className="grow-1 text-xs font-medium text-default-700 ">
            ...
            <TabsContent value="link">
              ...
              <div className="flex items-center gap-2 mt-5">
                <Checkbox id="cb2" />
                <Label htmlFor="cb2" className="grow-1 text-xs font-medium text-default-700 ">
                  Don’t show this again
                </Label>
              </div>
            </TabsContent>
        ...
        <DialogContent overlayClass="backdrop-blur-none">
          ...
          <Tabs defaultValue="link" className=" w-full">
            ...
            <TabsContent value="code">
              ...
              <div className="flex items-center gap-2 mt-5">
                <Checkbox id="cb3" />
                <Label htmlFor="cb3" className="grow-1 text-xs font-medium text-default-700 ">
                  Don’t show this again
                </Label>
              </div>
            </TabsContent>
            <TabsContent value="link">
              ...
              <div className="flex items-center gap-2 mt-5">
                <Checkbox id="cb4" />
                <Label htmlFor="cb4" className="grow-1 text-xs font-medium text-default-700 ">
                  Don’t show this again
                </Label>
              </div>
            </TabsContent>
        ...
        <DialogContent overlayClass="backdrop-blur-none bg-transparent">
          ...
          <Tabs defaultValue="link" className=" w-full">
            ...
            <TabsContent value="code">
              ...
              <div className="flex items-center gap-2 mt-5">
                <Checkbox id="cb5" />
                <Label htmlFor="cb5" className="grow-1 text-xs font-medium text-default-700 ">
                  Don’t show this again
                </Label>
              </div>
            </TabsContent>
            <TabsContent value="link">
              ...
              <div className="flex items-center gap-2 mt-5">
                <Checkbox id="cb6" />
                <Label htmlFor="cb6" className="grow-1 text-xs font-medium text-default-700 ">
                  Don’t show this again
                </Label>
              </div>
            </TabsContent>
        ...
        <DialogContent overlayClass=" bg-gradient-to-b from-background/60 to-primary/30">
          ...
          <Tabs defaultValue="link" className=" w-full">
            ...
            <TabsContent value="code">
              ...
              <div className="flex items-center gap-2 mt-5">
                <Checkbox id="cb7" />
                <Label htmlFor="cb7" className="grow-1 text-xs font-medium text-default-700 ">
                  Don’t show this again
                </Label>
              </div>
            </TabsContent>

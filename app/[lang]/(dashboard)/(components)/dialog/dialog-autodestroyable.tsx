    ...
    <Dialog open={open}>
      ...
      <DialogContent>
          ...
          <div className="sm:grid sm:grid-cols-2 mt-5 sm:gap-5">
            <Label htmlFor="basic" className="border-2 rounded-sm border-border p-3">
              <div className="flex justify-between items-center">
                <h3 className="grow text-xs font-semibold text-default-700 ">Basic Plan</h3>
              ...
              <div className="mt-1">
                ...
                <p className="text-[10px] text-default-500">Includes 20GB individual data</p>
              </div>
            ...
            <Label htmlFor="standard" className="border-2 rounded-sm border-border p-3">
              <div className="flex justify-between items-center">
                <h3 className="grow text-xs font-semibold text-default-700 ">Standard Plan</h3>
        ...
        <DialogFooter className="mt-6">
          <Button variant="outline" onClick={() => setOpen(false)} color="warning">
            Cancel
          </Button>

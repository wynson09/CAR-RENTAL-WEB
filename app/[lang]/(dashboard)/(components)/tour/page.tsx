            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-sm text-default-400 dark:text-default-600  mb-4">
                  The <code className="text-primary">steps and tourOptions</code> props passes data
                  in <code className="text-primary">ShepherdTour</code> component to navigate the
                  tour.
                </p>
              </CardContent>
              <CardContent>
                ...
                <p className=" text-muted-foreground mb-4">
                  Use when you want to help users along getting accustomed to your user interface or
                ...
                <div>
                  <div>
                    <div className="text-center mt-4 mb-5 max-w-[400px] mx-auto">
                      <div className="py-3 px-2  inline-block text-xl font-bold" id="logo-tour">
                        <div className="w-30 h-5">
                          <Image className="w-full h-full" src={tourlogo} alt=" dashtail logo" />
                        </div>
                      </div>
                      ...
                      <p className=" text-muted-foreground text-sm mb-3">
                        ...
                        Suspendisse ultricies mi eros, sit amet tempor nulla varius sed dapibus in
                        tellus.
                      </p>
                  ...
                  <div className=" grid xl:grid-cols-3 grid-cols-1 gap-5">
                    ...
                    <Card className="border shadow-none p-4">
                      <CardContent className="text-center">
                        <div className="mx-auto h-20 w-20 mb-4">
                          ...
                          >
                            <Icon icon="heroicons:user-plus" className=" h-6 w-6 text-primary" />
                          </div>
                        </div>
                        <h5 className="mb-2 text-default-700  font-medium text-base ">
                          Log in account
                    ...
                    <Card id="getproduct-tour" className="border shadow-none p-4">
                      <CardContent className="text-center">
                        <div className="mx-auto h-20 w-20 mb-4">
                          <div className="flex items-center justify-center bg-accent dark:bg-default-200  rounded-full overflow-hidden w-20 h-20">
                            <Icon

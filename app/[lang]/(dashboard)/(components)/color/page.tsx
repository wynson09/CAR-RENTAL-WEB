      ...
      <CardContent>
        ...
        <div className="mt-5 flex flex-wrap gap-2">
          <div className="border border-default-200 rounded w-24">
            ...
            <div className="p-2">
              <div className="text-sm font-medium text-default-800 mb-[2px]">White</div>
          ...
          <div className="border border-default-200 rounded w-24">
            ...
            <div className="p-2">
              <div className="text-sm font-medium text-default-800 mb-[2px]">Dark</div>
        ...
        <div className="text-lg font-medium text-default-900 mt-9 mb-6">Primary</div>
        <div className="flex flex-wrap gap-2">
          {primaryColors.map((item, index) => (
            <div className="border border-default-200 rounded " key={`primary-color-${index}`}>
              <div
                className={`h-14 w-full bg-${item.name} border-b border-default-200 min-w-[100px] rounded-t`}
              ></div>
              <div className="p-2">
                <div className="text-sm font-medium text-default-800 mb-[2px]">{item.name}</div>
        ...
        {/* Default Color */}
        <div className="text-lg font-medium text-default-900 mt-9 mb-6">Default</div>
        <div className="flex flex-wrap gap-2">
          {defaultColors.map((item, index) => (
            <div className="border border-default-200 rounded " key={`default-color-${index}`}>
              <div
        ...
        {/* Destructive Color */}
        <div className="text-lg font-medium text-default-900 mt-9 mb-6">Destructive</div>
        <div className="flex flex-wrap gap-2">

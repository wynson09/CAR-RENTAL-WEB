  ...
  return (
    <div className=" space-y-5">
      ...
      <Card title="Size Button" code={sizeButton}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The <code className="text-primary">size</code> prop is used to change the button sizes
        </p>
        <div className="flex flex-wrap gap-3 lg:gap-5">
          <SizeButton />
        </div>
      ...
      <Card title="Outline Buttons" code={outlineButton}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The <code className="text-primary"> variant="outline" </code> prop is used to for Outline
          Button
        </p>
        <div className="flex flex-wrap gap-3 lg:gap-5">
          <OutlineButton />
      ...
      <Card title="Raised" code={raisedButton}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          You can use direct <span className=" font-medium">TawlindCss</span> className{' '}
          <code className="text-primary">shadow-md, shadow-sm, shadow-xs</code> for shadow
        </p>
        <div className="flex flex-wrap gap-3 lg:gap-5">
          <RaisedButton />
        </div>
      ...
      <Card title="Rounded" code={roundedButton}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          You can use direct <span className=" font-medium">TawlindCss</span> className{' '}
          <code className="text-primary">rounded-full</code> for or any other's className
        </p>
        <div className="flex flex-wrap gap-3 lg:gap-5">
          <RoundedButton />
        </div>
      ...
      <Card title="Ghost Buttons" code={ghostButton}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The <code className="text-primary">variant='ghost'</code> prop is used to change for soft
          color
        </p>
        <div className="flex flex-wrap gap-3 lg:gap-5">
          <GhostButton />
      ...
      <Card title="Disabled" code={disabledButton}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The <code className="text-primary">disabled</code> prop disables any action of the button
        </p>
        <div className="flex flex-wrap gap-3 lg:gap-5">
          <DisabledButton />
        </div>
      ...
      <Card title="Icon Buttons" code={iconButton}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The <code className="text-primary">size='icon'</code> props design size of the button as
          icon
        </p>
        <div className="flex flex-wrap gap-3 lg:gap-5">
          <IconButton />
      ...
      <Card title="Loading" code={loaderButton}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The <code className="text-primary">Loader</code> component design the button as loading
          button
        </p>
        <div className="flex flex-wrap gap-3 lg:gap-5">
          <LoaderButton />
      ...
      <Card title="Block Buttons" code={blockButton}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The <code className="text-primary">full width</code> design the button as block button.
        </p>
      ...
      <Card title="Social Buttons" code={socialButton}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The <code className="text-primary">size='icon'</code> props design the button with icon
        </p>
      ...
      <Card title="Buttons Toggle Status" code={toggleButton}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The <code className="text-primary">Toggle</code> component design the button works toggle
        </p>
        <ToggleButton />
      </Card>
    </div>

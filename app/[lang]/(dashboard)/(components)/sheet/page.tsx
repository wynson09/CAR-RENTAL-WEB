  ...
  return (
    <div className=" space-y-5">
      <Card title="Basic Sheet" code={basicSheet}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          ...
          <code className="text-primary">
            SheetTrigger, SheetContent, SheetHeader, SheetTitle, SheetDescription , SheetFooter,
            SheetClose
          </code>{' '}
          component to make sheet and wrap it as necessary to make sheet close.{' '}
          <code className="text-primary">side</code> props helps to identify from where the sheet
          will come from.
        </p>
      ...
      <Card title="Extra Actions" code={extraActionsSheet}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          In the extra action component there wil be new section to the bottom of the sheet that has
          two button to do some action. That added extra functionality to this component.
        </p>
        <div className="flex flex-wrap gap-5">
      ...
      <Card title="Submit Form In Sheet" code={submitFormInSheet}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          Adding component to the sheet like a form. Give extra facility to so that this could help
          the user to add information.
        </p>
      ...
      <Card title="Multi-Label Sheet" code={multiLabelSheet}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          Multi Label sheet is all about nested sheet. Specially when we need extra functionality in
          a simple design the we come with a idea of multi label sheet. That could be a nested form
          or information.
        </p>
        <div className="space-x-5">
          <MultiLabelSheet />
      ...
      <Card title="Preview Sheet" code={previewSheet}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          Preview sheet is to show some information in different idea and details about someone that
          might help us to know about the product or person on permission.
        </p>
        <div className="max-w-[684px] border rounded-[6px]">
          <div className="flex flex-col sm:flex-row p-3 pt-4 sm:pt-3">
            <div className="flex-1 flex flex-col sm:flex-row items-center gap-2 text-center sm:text-start">
              ...
              <div className="mt-2 sm:mt-0">
                <h4 className="text-sm font-medium text-default-950 ">Hey Prantik</h4>
                <p className="text-sm text-default-500 mt-1 sm:mt-0 ">Read Some Preview Text</p>
              </div>
            </div>
            <PreviewSheet />
          </div>
          ...
          <div className="flex flex-col sm:flex-row p-3 pt-4 sm:pt-3">
            <div className="flex-1 flex flex-col sm:flex-row items-center gap-2 text-center sm:text-start">
              ...
              <div className="mt-2 sm:mt-0">
                <h4 className="text-sm font-medium text-default-950 ">Hey Hasi</h4>
                <p className="text-sm text-default-500 mt-1 sm:mt-0">Read Some Preview Text</p>
              </div>
            </div>
            <PreviewSheet />

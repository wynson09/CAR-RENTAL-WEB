    ...
    <Card>
      ...
      <CardContent>
        <div className="text-sm text-default-600 mb-3">
          Hi I'm Jennyfer Frankin, It will be as simple as Occidental; in fact, it will be
          Occidental. To an English person, it will seem like simplified English, as a skeptical
          Cambridge friend of mine told me what Occidental is European languages are members of the
          same family.
        </div>

    ...
    <div className="flex h-full flex-col px-6 mt-2">
      <div>
        ...
        <div className="flex items-center gap-2 mt-6">
          ...
          <div>
            <div className="text-sm font-medium text-default-900">Esther Howard</div>
            <div className="text-sm text-default-600">esther.howard@gmail.com</div>
          </div>
        </div>
        <div className="mt-8">
          <div className="space-y-4">
            ...
            <div className="text-sm text-default-600">
              ...
              these 10 clever ways to omen your next blog
            </div>
            <div className="text-sm text-default-600">
              posr with a bang With resrpect, i must disagree with Mr.Zinsser. We all know the most
              part of important part of any article is the title.Without a compelleing title, your
              reader won't even get to the first sentence.After the title, however, the first few
        ...
        <div className="text-base font-medium text-default-900">Attachments (3) </div>
        ...
        <div className="flex items-center gap-4 pb-5">
          <Button>
            <Icon icon="heroicons:arrow-uturn-left" className="w-4 h-4 ltr:mr-1 rtl:ml-1" /> Reply
          </Button>

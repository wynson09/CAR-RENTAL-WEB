    ...
    <Dialog>
      ...
      <DialogContent>
        ...
        <div className="text-sm text-default-500  mt-8">
          <RadioGroup className="flex flex-col gap-3" defaultValue="messageNotification">
            <RadioGroupItem value="messageNotification" id="messageNotification">
              Mute message notifications{' '}
            </RadioGroupItem>
            <RadioGroupItem value="callNotification" id="callNotification">
              Mute call notifications{' '}
            </RadioGroupItem>
            <RadioGroupItem value="messageCallNotification" id="messageCallNotification">

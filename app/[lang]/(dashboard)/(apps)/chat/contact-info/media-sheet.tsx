    ...
    <Card className="absolute top-0 right-0 w-full h-full z-10 bg-card">
      <CardHeader className="mb-0">
        <div className="flex gap-2.5 items-center">
          ...
          >
            <Icon icon="mynaui:arrow-left" className="text-default-900 text-2xl" />
          </Button>
          <span className="text-base font-medium text-default-900"> Media, Files and Links</span>
        </div>
      </CardHeader>
      <CardContent className="px-2 pt-5 h-full">
        <Tabs defaultValue={showDrawer ? showDrawer : 'media'} className="h-full ">
            ...
            <ScrollArea className="h-full">
              <TabsContent value="media">
                <div className="grid grid-cols-2 gap-2 mt-8">
                  <Link href="/images/all-img/baby.jpg" target="_blank" download>
                    <Image
                      placeholder="blur"
                      src={baby}
                      alt=""
                  ...
                  <Link href="/images/all-img/banana.jpg" target="_blank" download>
                    <Image
                      placeholder="blur"
                      src={banana}
                      alt=""
                  ...
                  <Link href="/images/all-img/busket.jpg" target="_blank" download>
                    <Image
                      placeholder="blur"
                      src={busket}
                      alt=""
                  ...
                  <Link href="/images/all-img/orange.jpg" target="_blank" download>
                    <Image
                      placeholder="blur"
                      src={orange}
                      alt=""
                  ...
                  <Link href="/images/all-img/water-fall.jpg" target="_blank" download>
                    <Image
                      placeholder="blur"
                      src={waterfall}
                      alt=""
              ...
              <TabsContent value="files">
                ...
                >
                  <div className="h-16 w-16 rounded-sm bg-default-50 flex justify-center items-center">
                    <Icon icon="mdi:file-text-edit-outline" className="text-3xl text-default-700" />
                  </div>
                  <div>
              ...
              <TabsContent value="links">
                ...
                >
                  <div className="h-16 w-16 rounded-sm bg-default-50 flex justify-center items-center">
                    <Icon icon="bx:link" className="text-3xl text-default-700" />
                  </div>
                  <div>
                    <div className="text-sm text-default-500 group-hover:text-default-800">
                      Stack Overflow
                    </div>
                    <p className="text-sm text-default-500">Developer Meeting place</p>
                  </div>
                </Link>
                <Link
                  target="_blank"
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-default-500">Sell Your code here</p>
                  </div>
                </Link>
              </TabsContent>
            </ScrollArea>

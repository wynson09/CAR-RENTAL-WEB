...
const DetailsCard = ({ item, index }: { item: Data; index: number }) => {
  ...
  return (
    ...
    >
      <div
        className={`flex flex-col items-center  p-4  mb-3 rounded-lg  relative pt-12 bg-${color}/10 ${index < 1 && 'sm:-mt-8'}`}
      >
        <div className="flex-1 w-full flex flex-col items-center gap-3 absolute -top-10 left-1/2 -translate-x-1/2">
          ...
          <div className="flex flex-col items-center gap-2 ">
            ...
            <Badge className="rounded-full h-8 " color={index === 1 ? 'default' : (color as any)}>

    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <Card title="Default Switch" code={defaultSwitch}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          No<code className="text-primary"> props </code> are required for our default style.
        </p>
        <DefaultSwitch />
      </Card>
      <Card title="Switch With Label" code={switchWithLabel}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          Use<code className="text-primary"> Label component </code> for the switch label.
        </p>
        <SwitchWithLabel />
      </Card>
      <Card title="Disabled Switch" code={disabledSwitch}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          Use the<code className="text-primary"> disabled </code> attribute to disabled the switch.
        </p>
        <DisabledSwitch />
      </Card>
      <Card title="Switch Size" code={switchSize}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          ...
          <code className="text-primary">small (sm), medium (md) and large (lg)</code> .
        </p>
        <SwitchSize />
      </Card>
      <Card title="Switch With Icon" code={switchWithIcon}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          ...
          <code className="text-primary">endContent</code> properties to display the icon.
        </p>
        <SwitchWithIcon />
      </Card>
      <Card title="Switch With Thumb Icon" code={switchWithThumbIcon}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          {' '}
          Use the <code className="text-primary">thumbIcon</code> property to display the icon.
        </p>
        <SwitchWithThumbIcon />
      </Card>
      <Card title="Colors" code={colorsSwitch}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          ...
          <code className="text-primary">primary, indfo, warning, success, destructive</code> .
        </p>
        <ColorsSwitch />
      </Card>
      <Card title="Thumb Size" code={thumbSize}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          Use the <code className="text-primary">thumbSize</code> class to adjust the size of the
          thumb.
        </p>
        <ThumbSize />
      </Card>
      <Card title="Controlled Switch" code={controlledSwitch}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          Use the <code className="text-primary">handleCheckedChange</code> method to capture the
          switch value.
        </p>
        <ControlledSwtich />
      </Card>
      <Card title="Switch with Badge" code={switchWithBadge}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          Use <code className="text-primary">startContent="On" and endContent="Off"</code> as label
          text for the switch. You can customize the "On" and "Off" labels as needed.
        </p>
        <SwitchWithBadge />
      </Card>

...
const CustomizedSwitch = () => {
  ...
  return (
    <div className="flex flex-wrap items-center gap-6">
      ...
      <Switch color="info" size="lg" startContent={<Bell />} endContent={<Bell />} />
      <div className="flex items-center gap-2">
        <button type="button" className="text-base text-default-600" onClick={disabledChecked}>
          off
        </button>
        <Switch defaultChecked={checked} />
        <button type="button" className="text-base text-default-600" onClick={enabledChecked}>
          on
        </button>
      </div>
    </div>

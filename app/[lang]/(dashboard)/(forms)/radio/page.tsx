    ...
    <div className="space-y-6 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-6">
      <Card title="Basic Radio Button" code={basicRadio}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          No <span className="text-primary">Props</span> are required for the default radio
          input.{' '}
        </p>
        <BasicRadio />
      </Card>
      <Card title="Disabled Radio Button" code={disabledRadio}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          Use the <span className="text-primary">disabled</span> attribute to deactivate the radio
          input.
        </p>
        <DisabledRadio />
      </Card>
      <Card title="Sizes Radio Button" code={sizesRadio}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The size prop is used to change the input radio sizes. Our available sizes are{' '}
          <span className="text-primary">
            extra-small(xs), small (sm), medium (md), large (lg), and extra-large (xl)
          </span>
          .{' '}
        </p>
        <SizesRadio />
      ...
      <Card title="Radio Button Right" code={radioRight}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          Our design system offers flexibility; you can effortlessly shift the input and label to
          the left or right by adjusting the position of the label and input, or alternatively, you
          can modify it using the flex property.
        </p>
        <RadioRight />
      </Card>
      ...
      <Card title="Colors Radio Button" code={colorsRadio}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The <span className="text-primary">color</span> prop is used to change the input color.
      ...
      <Card title="Controlled Radio Button" code={controlledRadio}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          Pass the <span className="text-primary">handleSelect</span> method through the{' '}
          <span className="text-primary">onValueChange</span> props to collect radio input data.
        </p>
        <ControlledRadio />
      </Card>
      ...
      <Card title="Disabled Radio Group" code={disabledRadioGroup}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          Disable the selection by passing the <span className="text-primary">disabled props</span>{' '}
          to the <span className="text-primary">RadioGroup</span> component.
        </p>
        <DisabledRadioGroup />
      </Card>
      <Card title="Horizontal Radio Group" code={horizontalRadioGroup}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          Our radio group inputs are horizontally aligned by default; no action is required.
        </p>
        <HorizontalRadioGroup />
      </Card>
      <Card title="Vertical Radio Group" code={horizontalRadioGroup}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          ...
          <span className="text-primary">className prop</span> of the RadioGroup component.
        </p>
        <VerticalRadioGroup />
      </Card>
      ...
      <Card title="Icons Radio Button" code={iconInRadio}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          To show icon in radio button we can use <code className="text-primary">icon </code> prop
          that passes different icon to show in radio button.
        </p>
        <IconInRadio />
      </Card>
      <Card title="Label Slot Radio Button" code={labelSlot}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          Label slot for radio button can be use alternative of RadioButton Wrapper and use{' '}
          <code className="text-primary">Label </code> component to show label with the component
          and customize it on label.
        </p>
        <LabelSlot />
      </Card>
      <Card title="Custom Implementations Radio Button" code={customImplementation}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          Custom component for radio button <code className="text-primary">RadioGroup </code>{' '}
          component wrap the label with the
          <code className="text-primary"> RadioGroupItem </code> to separate different item to
          select.
        </p>
        <CustomImplementation />
      </Card>
      <Card title="Accessible Radio Button " code={accessibleRadio}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          Accessible button for radio button <code className="text-primary">RadioGroup </code>{' '}
          component wrap the label with the
          <code className="text-primary"> RadioGroupItem </code> to separate different item to
          select and use dynamic class to show selected item.
        </p>
        <AccessibleRadio />
      </Card>
      <Card title="Radio Button With Background" code={radioWithBackground}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          Background radio for radio button <code className="text-primary">RadioGroup </code>{' '}
          component wrap the label with the
          <code className="text-primary"> RadioGroupItem </code> to separate different item to
          select and use dynamic class to show different background.
        </p>
        <RadioWithBackground />
      </Card>
      <div className="col-span-2">
        <Card title="Custom Style Radio Button" code={customStyledRadio}>
          <p className="text-sm text-default-400 dark:text-default-600  mb-4">
            Custom style for radio button <code className="text-primary">RadioGroup </code>{' '}
            component wrap the label with the
            <code className="text-primary"> RadioGroupItem </code> to separate different item to
            select and use dynamic class to show different item as profile.
          </p>
          <CustomStyledRadio />
        </Card>
      </div>
      <div className="col-span-2">
        <Card title="Group Styled As Tiles Radio Button" code={radioTylesGrouped}>
          <p className="text-sm text-default-400 dark:text-default-600  mb-4">
            Group Styled component for radio button{' '}
            <code className="text-primary">RadioGroup </code> component wrap the label with the
            <code className="text-primary"> RadioGroupItem </code> to separate different item to
            select and use dynamic class to show different item as different item.
          </p>
          <RadioTylesGrouped />
        </Card>
      </div>
      <div className="col-span-2">
        <Card title="Radio Cards" code={radioCards}>
          <p className="text-sm text-default-400 dark:text-default-600  mb-4">
            Card Styled component for radio button <code className="text-primary">RadioGroup </code>{' '}
            component wrap the label with the
            <code className="text-primary"> RadioGroupItem </code> to separate different item to
            select and use dynamic class to show different item as different item.
          </p>

  ...
  return (
    <RadioGroup defaultValue="label_slot_1" className="flex flex-col">
      <div className="flex items-center gap-2">
        ...
        <Label htmlFor="label_slot_1" className="text-base text-muted-foreground font-normal">
          I agree with your
      ...
      <div className="flex items-center gap-2">
        ...
        <Label htmlFor="label_slot_2" className="text-base text-muted-foreground font-normal">
          I agree with your

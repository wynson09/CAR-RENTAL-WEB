...
const InputVariant = () => {
  return (
    <div className="grid grid-cols-2 gap-6">
      ...
      <Input type="text" placeholder="Underline" variant="underline" radius="none" />
      <Input type="text" placeholder="Faded - background and borderline" variant="faded" />
      <Input type="text" placeholder="shadow input" shadow="md" />
      <Input type="text" placeholder="background" variant="flat" color="primary" />

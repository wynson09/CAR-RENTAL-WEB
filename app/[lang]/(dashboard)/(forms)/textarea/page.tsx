  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <Card title="Disabled Textarea" code={disabledTextarea}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          Use <span className="text-primary">disabled</span> attribute to disable textarea.
        </p>
        <DisabledTextarea />
      </Card>
      <Card title="Readonly Textarea" code={readonlyTextarea}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          Apply <span className="text-primary">the readonly attribute</span> to make the textarea
          non-editable.
        </p>
        <ReadonlyTextarea />
      </Card>
      ...
      <Card title="Required Textarea" code={requiredTextarea}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          Use <span className="text-primary">required</span> attribute to required textarea.
        </p>
        <RequiredTextarea />
      </Card>
      <Card title="Textarea with description" code={textareaWithDescription}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          Use the <span className="text-primary">description</span> below the textarea field.
        </p>
        <TextareaWithDescription />
      </Card>
      <Card title="Displayed Rows" code={displayedRows}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          Use the <span className="text-primary">rows</span> prop in the textarea field to add extra
          row in the field.
        </p>
        <DisplayedRows />
      </Card>
      <Card title="Colors" code={colorsTextarea}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The <span className="text-primary">color</span> prop is used to change the textarea color.{' '}
          <br />

    ...
    <div>
      <div className={`w-full h-[${height}px]`}>
        <VectorMap
          ...
          className="h-full w-full object-cover dashtail-codeVmapInfo"
        />
      </div>
      <div className="text-center">
        <p className="text-sm font-medium text-card-foreground">
          Hovered: {hovered && <strong className="text-primary">{hovered}</strong>}
        </p>
        <p className="text-sm font-medium text-card-foreground">
          Focused: {focused && <strong className="text-primary">{focused}</strong>}
        </p>
        <p className="text-sm font-medium text-card-foreground">
          Clicked: {clicked && <strong className="text-primary">{clicked}</strong>}
        </p>
      </div>
    </div>
  );
